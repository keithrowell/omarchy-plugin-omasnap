 ...
 * to colours) plus the theme colours it needs. `wallpaperOverride` (the
 * `--wallpaper` flag) wins over `theme.wallpaper`; either resolves to `null`
 * when the file does not exist, per the spec's "wallpaper missing" edge case.
 */
export function buildInput({ snap, theme, wallpaperOverride } = {}) {
